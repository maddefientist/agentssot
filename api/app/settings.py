...
class Settings(BaseSettings):
    ...
    synthesis_fallback_model: str = Field(default="qwen3.5:27b", alias="SYNTHESIS_FALLBACK_MODEL")
    synthesis_schedule_hour: int = Field(default=3, alias="SYNTHESIS_SCHEDULE_HOUR")
    synthesis_window_days: int = Field(default=7, alias="SYNTHESIS_WINDOW_DAYS")
